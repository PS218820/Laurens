  ...
  <body class="bg-gray-100 font-sans leading-normal tracking-normal">
  		...
  		<div class="w-full md:max-w-4xl mx-auto flex flex-wrap items-center justify-between mt-0 py-3">
            ...
            <li>
              @if (Route::has('login'))
                  <div>
                      @auth
                          <a href="{{ url('/dashboard') }}" class="inline-block py-2 px-4 text-gray-900 font-bold no-underline">Dashboard</a>
                      @else
    ...
    <div class="container w-full md:max-w-3xl mx-auto pt-20">
  		...
  		<div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" style="font-family:Georgia,serif;">
  			...
  			<!--Title-->
  			<div class="font-sans">
  						<h1 class="font-bold font-sans break-normal text-gray-900 pt-6 pb-2 text-3xl md:text-4xl">Dashboard</h1>
  			</div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              ...
              <form action="{{ route('projects.store')  }}" method="POST">
                ...
                <p>description:</p>
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="description" class="form-control" placeholder="description">
                <p>finished:</p>
